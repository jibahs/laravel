<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-20">
        ...
        <div class="flex mt-6 items-center justify-between">
            ...
            <a href="{{ route('products.create') }}">
                <button class="bg-gray-100 px-8 py-2 rounded-md font-semibold">Add</button>
            </a>
        </div>

        <div class="grid md:grid-cols-4 grid-cols-1 mt-2 gap-6">
